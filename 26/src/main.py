...
flower_f1 = IR("data/flower_f1.png", 30, 30)
flower_f2 = IR("data/flower_f2.png", 30, 30)
speed = 1
...
while True:
    ...
    # Move player
    #if k[]
    right = k["right"] or k["d"]
    left = k["left"] or k["a"]
    if right and (facing_right == False):
        facing_right = True
    if left and (facing_right == True):
        facing_right = False
    m.x += right - left
